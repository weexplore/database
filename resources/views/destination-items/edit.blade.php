                    ...
                    >
                        ...
                        <div class="bg-white shadow-sm sm:rounded-lg p-6 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <input
                                    type="hidden"
                                    name="open_website_after_save"
                                    id="open-website-after-save"
                                    value=""
                                >

                                <input
                                    type="hidden"
                                    id="open-website-after-save-url"
                                    value="{{ session('open_website_after_save_url', '') }}"
                                >
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <p id="website-open-help" class="mt-1 text-xs text-gray-500">
                                        Enter a valid website to enable this button.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 space-y-4">
                                ...
                                <div
                                    id="destination-item-map"
                                    class="h-96 w-full rounded-lg border border-gray-300 overflow-hidden"
                                ></div>
                ...
                <div class="xl:col-span-1 space-y-6">
                            ...
                            <div class="p-4">
                                <dl class="space-y-3 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <dd class="text-gray-900">
                                            {{ $destinationItem->destination->destinationtype ?: '—' }}
                                        </dd>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <dd class="text-gray-900">
                                            {{ $destinationItem->destination->place?->placename ?: '—' }}
                                        </dd>
                                    </div>
                                </dl>
                            </div>
                            ...
                            <div class="p-4">
                                <dl class="space-y-3 text-sm">
                                    <div>
                                        ...
                                        <dd class="text-gray-900">
                                            {{ $destinationItem->place->placename ?: '—' }}
                                        </dd>
                                    </div>
                                    ...
                                    <div>
                                        <dt class="text-gray-500">Type</dt>
                                        <dd class="text-gray-900">
                                            {{ $destinationItem->place->placetype ?: '—' }}
                                        </dd>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <dd class="text-gray-900">
                                            {{ $destinationItem->place->locality ?: '—' }}
                                        </dd>
                                    </div>
                                </dl>
                            </div>
                    ...
                    <div class="bg-white shadow-sm sm:rounded-lg">
                        <div class="px-4 py-3 border-b border-gray-200">
                            ...
                            <p class="mt-1 text-xs text-gray-500">
                                Trip legs linked to this destination item.
                            </p>
                        </div>
                        ...
                        <div class="p-4">
                                    ...
                                    @foreach ($travelLegs as $tripLeg)
                                        <div class="rounded-md border border-gray-200 px-3 py-3">
                                            <div class="flex items-start justify-between gap-3">
                                                ...
                                                <div class="shrink-0">
                                                    @if ($tripLeg->historylinktype === 'start_item')
                                                        <span class="rounded-full bg-sky-100 px-2 py-0.5 text-[10px] font-medium text-sky-800">
                                                            Start
                                                        </span>
                                                    @elseif ($tripLeg->historylinktype === 'end_item')
                                                        <span class="rounded-full bg-green-100 px-2 py-0.5 text-[10px] font-medium text-green-800">
                                                            End
                                                        </span>
                                                    @else
                            ...
                            @else
                                <p class="text-sm text-gray-500">
                                    This destination item has not yet been linked to a travel leg.
                                </p>
                            @endif
                        </div>
                    </div>
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                >
                                                    @foreach ($sourceTypeOptions as $value => $label)
                                                        <option
                                                            value="{{ $value }}"
                                                            @selected($source->sourcetype === $value)
                                                        >
                                                            {{ $label }}
                                                        </option>
                                                    @endforeach
                                                ...
                                                <div>
                                                    ...
                                                    >
                                                        @foreach ($sourceImportStatusOptions as $value => $label)
                                                            <option
                                                                value="{{ $value }}"
                                                                @selected($source->importstatus === $value)
                                                            >
                                                                {{ $label }}
                                                            </option>
                                                        @endforeach
                                            ...
                                            <div>
                                                ...
                                                <textarea
                                                    ...
                                                    rows="3"
                                                    class="w-full rounded-md border-gray-300 shadow-sm text-sm"
                                                >{{ $source->importedsummary }}</textarea>
                                            </div>
                    ...
                    <div class="bg-white shadow-sm sm:rounded-lg">
                        <div class="px-4 py-3 border-b border-gray-200">
                            <h3 class="text-sm font-semibold text-gray-900">
                                Destination Item Reviews
                            </h3>

                            <p class="mt-1 text-xs text-gray-500">
                                Reviews linked to this destination item
                            </p>
                        </div>
                        ...
                        <div class="p-4 space-y-4">
                            ...
                            @else
                                <p class="text-sm text-gray-500">
                                    No reviews are currently linked to this destination item.
                                </p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="bg-white shadow-sm sm:rounded-lg">
                        <div class="px-4 py-3 border-b border-gray-200">
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">
                                    {{ $destinationItem->attachments->count() }}
                                    linked record{{ $destinationItem->attachments->count() === 1 ? '' : 's' }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="p-4 space-y-4">
                            ...
                            @else
                                <p class="text-sm text-gray-500">
                                    Attachments module not yet enabled.
                                </p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        ...
                        <dl class="mt-3 space-y-2 text-sm">
                            ...
                            <div class="flex justify-between gap-4">
                                ...
                                <dd class="text-right text-gray-900">
                                    @if ($destinationItem->visitinterestlevel)
                                        {{ \App\Models\DestinationItem::visitInterestOptions()[$destinationItem->visitinterestlevel] ?? $destinationItem->visitinterestlevel }}
                                    @else
                                        —
                                    @endif
                                </dd>
                            ...
                            <div class="flex justify-between gap-4">
                                ...
                                <dd class="text-right text-gray-900">
                                    {{ $destinationItem->hasvisited ? 'Yes' : 'No' }}

                                    @if ($destinationItem->visitedat)
                                        · {{ $destinationItem->visitedat->format('d M Y') }}
                                    @endif
                                </dd>
                            </div>

                            <div class="flex justify-between gap-4">
                                <dt class="text-gray-500">Still want to visit</dt>
                                <dd class="text-right text-gray-900">
                                    {{ $destinationItem->stillwanttovisit ? 'Yes' : 'No' }}
                                </dd>
                            </div>
                            ...
                            <div class="flex justify-between gap-4">
                                ...
                                <dd class="text-gray-900">
                                    {{ optional($destinationItem->createdat)->format('d M Y') ?: '—' }}
                                </dd>
                            </div>
                            ...
                            <div class="flex justify-between gap-4">
                                ...
                                <dd class="text-gray-900">
                                    {{ optional($destinationItem->updatedat)->format('d M Y') ?: '—' }}
                                </dd>
                            </div>
                        </dl>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (placeSelect && destinationSelect) {
                const destinationOptions = Array.from(
                    destinationSelect.querySelectorAll('option')
                )
                    ...
                    .map(option => ({
                        ...
                        placeId: option.dataset.placeId
                            ? String(option.dataset.placeId)
                            : '',
                    }));

                function rebuildDestinationOptions() {
                    const selectedPlaceId = placeSelect.value
                        ? String(placeSelect.value)
                        : '';

                    const previousDestinationId = destinationSelect.value
                        || destinationSelect.dataset.selectedDestinationId
                        || '';
                    ...
                    const selectedStillExists = matchingDestinations.some(option => {
                        return String(option.value) === String(previousDestinationId);
                    });
            ...
            const toggleItemSourceCreateButton = document.getElementById(
                'toggle-item-source-create'
            );

            const itemSourceCreateForm = document.getElementById(
                'destination-item-source-create-form'
            );

            const cancelItemSourceCreateButton = document.getElementById(
                'cancel-item-source-create'
            );
    ...
    <script>
        window.addEventListener('load', function () {
            ...
            function buildPreferredSearchText() {
                ...
                const addr1 = address1Input
                    ? address1Input.value.trim()
                    : '';

                const addr3 = address3Input
                    ? address3Input.value.trim()
                    : '';
            ...
            const map = L.map('destination-item-map').setView(
            ...
            if (searchButton) {
                searchButton.addEventListener('click', async function () {
                    ...
                    try {
                        ...
                        setStatus(
                            `Unable to search location right now. ${error.message}`
                        );
                    }
                });
            }
            ...
            setStatus(
                hasCoords
                    ...
                    : 'Click the map or search to set coordinates.'
            );
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                form.querySelectorAll('input, select, textarea').forEach(element => {
                    element.addEventListener('input', updateOpenButtonState);
                    element.addEventListener('change', updateOpenButtonState);
                });
