...
<div class="bg-white shadow-sm sm:rounded-lg p-6 space-y-6">
    <div class="flex items-center justify-between gap-4">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
                Record planned or actual accommodation, including dates, cost, travel origin, and review notes.
            </p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <div>
            ...
            {{-- Helper actions tied to the selected place --}}
        ...
        <div>
            ...
            <select id="triplegid" name="triplegid" class="mt-1 w-full rounded-md border-gray-300 shadow-sm text-sm">
                ...
                @foreach($tripLegs as $tripLeg)
                    <option value="{{ $tripLeg->id }}" @selected((string) old('triplegid', $tripStay->triplegid ?? '') === (string) $tripLeg->id)>
        ...
        <div>
            <label for="destinationitemid" class="block text-sm font-medium text-gray-700">
                Destination Item
            </label>
